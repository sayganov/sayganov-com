...
const linkClass =
  ...
  'rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 ' +
  'focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900'

export default function App() {
  return (
    <main className="flex min-h-dvh w-full items-center justify-center bg-zinc-900 p-4 text-white">
      <nav
