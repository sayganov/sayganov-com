...
const baseButtonClass =
  'flex-1 sm:flex-initial inline-flex min-h-11 items-center justify-center whitespace-nowrap ' +
  'px-5 py-2 text-sm font-medium rounded-md transition-colors cursor-pointer ' +
...
export function CookieBanner() {
  ...
  // Allow dismissing the banner with Escape (treated as declining consent).
  useEffect(() => {
  ...
  return (
    <div
      ...
      className="cookie-banner-enter fixed inset-x-0 bottom-0 z-50 border-t border-zinc-200 bg-white pb-[env(safe-area-inset-bottom)] pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)] shadow-[0_-4px_24px_rgba(0,0,0,0.1)] dark:border-zinc-700 dark:bg-zinc-800 dark:shadow-[0_-4px_24px_rgba(0,0,0,0.4)]"
    >
